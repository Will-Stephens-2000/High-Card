    ...
    if smallBlind.getMoney() <= blindAmount:
        ...
        while action != -1:
            if action == 0: # smallBlind's turn
                decisions = botAction(smallBlind, betSize - smallBlind.getMoneyInPot())
                ...
                if myDecision[0] == "Fold":
                    ...
                    pot += myDecision[1]
                    bigBlind.setMoneyInPot(bigBlind.getMoney() + myDecision[1])
                    break
                ...
                if myDecision[0] == "Fold":
                    ...
                    pot += raiseAmount
                    bigBlind.setMoneyInPot(bigBlind.getMoney() + raiseAmount)

                    betSize = raiseAmount - betSize
