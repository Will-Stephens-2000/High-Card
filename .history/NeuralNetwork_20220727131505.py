...
NUM_PARENTS = 4
def generateNewGeneration(players):
    newGen = players
    ...
    while currEle < len(newGen):
        ...
        weights1 = currentParents[0].getNeuralNet()
        weights2 = currentParents[1].getNeuralNet()

        newWeights = CROSSOVER_METHOD(weights1, weights2)
        newWeights = MUTATION_METHOD(weights1, weights2)
